 ...
 * they can create a published document directly, by putting the publication workflow class object in the document.
 ...
 * published document or when a new version of an existing document is created (both "creating" and "updating").
